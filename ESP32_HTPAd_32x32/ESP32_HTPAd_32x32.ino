...
void checkUDP() {
  ...
  if (packetSize) {
    ...
    if (strcmp(packetBuffer, "Calling HTPA series devices") == 0) {
      ...
      udp.print("HTPAxxxxxd v.2.20 Heimann Sensor GmbH; written by D. Pauer 2021-01-13\r\n");
    ...
    if (device_bind) {
      ...
      if (strcmp(packetBuffer, "G") == 0) {
        ...
        udp.print("HTPAxxxxxd 2021/01/13 v.2.20 Heimann Sensor GmbH; written by D. Pauer\n\r");
        udp.print("BIAS: ");
        if (bias_user < 0x10)
          udp.print("0");
