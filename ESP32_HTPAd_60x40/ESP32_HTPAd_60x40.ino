...
*********************************************************************************************************/
char ssid[] = "ReplaceThisWithYourWLANname";
char pass[] = "ReplaceThisWithYourWLANkey!";
...
word calc_timert(uint8_t clk, uint8_t mbit) {
  ...
  a = 0.95 * 4.0 * (float)(pow(2, (unsigned char)(mbit & 0b00001111)) + 100.0) / Fclk_float;
...
void initWIFI(void) {
  ...
  if ( strcmp(ssid, "ReplaceThisWithYourWLANname")) {
