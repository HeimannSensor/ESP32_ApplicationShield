 ...
 */
uint8_t TwoWire::requestFrom(uint16_t address, uint16_t size, bool sendStop)
{
...
uint8_t TwoWire::requestFrom(uint16_t address, uint16_t quantity, uint8_t sendStop)
{
...
uint8_t TwoWire::requestFrom(uint16_t address, uint16_t quantity)
{
